...
pub struct App {
    ...
    /// Selected when the reopened Argo CD view reports.
    argocd_reselect: Option<usize>,
    pub command: String,
    ...
    argocd_expanded: HashMap<usize, u64>,
